...
export function runModuleAiGeneration(input: ModuleAiInput): void {
  ...
  void (async () => {
    try {
      ...
      // 1) Esquema. La cantidad de secciones se dimensiona al documento: un RANGO (corto
      // → pocas secciones; largo → más) dentro del cual decide la IA según los subtemas
      // reales. Ni infla el temario repitiendo, ni empaca medio documento en una sección.
